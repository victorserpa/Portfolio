      ...
      <div className="rounded-3xl mt-3 bg-[#4b4661] drop-shadow-xl">
        <div className="p-10 mx-1 my-1 text-center">
          <img
            ...
            className="animate-pulse border-lime-500 border-2 rounded-full w-32 h-32 ml-16"
          />
          <br />
          <div>
      ...
      <div className="rounded-3xl mt-5 drop-shadow-xl bg-[#4b4661]">
        <div className="p-10 mx-2 my-1 container w-80">
          <div className="flex items-center my-3">
            <IconPing />
            <h1
              className="ml-3 text-1xl font-bold
            text-teal-400"
            >
              {Context.location}
            </h1>
          ...
          <div className="flex items-center my-3">
            <IconLinked />
            <a
              href="https://www.linkedin.com/in/victorserpa/"
              target="_blank"
              className="ml-3 text-1xl font-bold 
          text-teal-400 hover:text-white"
            >
          ...
          <div className="flex items-center my-3">
            <IconTt />
            <a
              href="https://twitter.com/schmvitor"
              target="_blank"
              className="ml-3 text-1xl font-bold 
            text-teal-400 hover:text-white"
            >
          ...
          <div className="flex items-center my-3">
            ...
            <a
              href="mailto:schmvitoor@gmail.com"
              className="text-1xl font-bold 
        text-teal-400 ml-3 hover:text-white"
            >
              schmvitoor@gmail.com
            </a>
          </div>
        </div>
      </div>
